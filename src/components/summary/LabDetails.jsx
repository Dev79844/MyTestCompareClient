...
export default function LabDetails(props) {
  ...
  console.log(lab)
  return (
    <div className="flex lg:relative flex-col items-center justify-center mt-5 lg:w-1/2 lg:after:absolute lg:after:bg-primary lg:after:w-[2px] lg:after:h-full lg:after:right-0 lg:after:top-0">
      <img
        src="images/summary-success/lab.png"
        alt="lab-logo"
        className="w-1/4 xs:w-[20%] md:w-32"
      />
      <h1 className="font-bold text-2xl mt-4">{lab.name}</h1>
